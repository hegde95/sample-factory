...
RUN_DESCRIPTION = RunDescription('doom_sound_memory', experiments=_experiments)

# For brain run using:
# python -m runner.run --run=doom_sound_memory --runner=processes --max_parallel=4 --experiments_per_gpu=1 --num_gpus=4